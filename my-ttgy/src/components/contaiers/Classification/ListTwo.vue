<template>
	<div id="fruitday-category" class="category-list listtwo">
		<header>
			<nav> 
				<div class="back"> 
			...
			<div class="section has-recommend">
				<div class="swiper-container swiper-container-horizontal swiper-container-wp8-horizontal">
				    <div class="swiper-wrapper" style="transition-duration: 0ms; transform: translate3d(0px, 0px, 0px);">
				        <div class="swiper-slide swiper-slide-prev" v-for="listSlider in swiper_slider" @click="activ(listSlider.id)" :key="listSlider.id">
        ...
        <div class="listtwo" style="min-height: 541px; width: 375px;">
        	<router-link :to="{name : 'Detail',params:{fid: item.id}}" class="item" href="#" v-for="item in shoplist" :key="item.id"> 
    			...
    			<div class="count">
    				...
    				<span data-id="27150" class="plus" @click="addToCart(detail)" >
    					<i class="iconfont">&#xe670;</i>
    				</span>
    			</div>   
    			<em></em>  
